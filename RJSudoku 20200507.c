...
#if RJ > 2
        int k[2] = {G[I].g[l[y][h[a][0]]], G[I].g[l[y][h[a][1]]]};
#endif
...
#if RJ > 2
        int k[3] = {G[I].g[l[y][h[a][0]]], G[I].g[l[y][h[a][1]]], G[I].g[l[y][h[a][2]]]};
#endif
...
#if RJ > 2
        int k[4] = {G[I].g[l[y][h[a][0]]], G[I].g[l[y][h[a][1]]], G[I].g[l[y][h[a][2]]], G[I].g[l[y][h[a][3]]]};
#endif
      ...
      for (y = 0; y < 2; ++y)// Search either away Line or away Box 6 Cell positions wise
      {
        ...
        {                    // Search Almost Locked Pair 54 mini-Lines away Line/Box 6 Cell positions wise
          if (!G[I].g[j[a][A]] || B[Y = G[I].g[j[a][A]] & ~(G[I].g[j[a][W[26][y] +
            ...
            B[G[I].g[j[a][A]]] < 3))
            continue;        // Skip for no Almost Locked Pair found
#if RJ > 2
          int k = G[I].g[j[a][A]];
#endif
...
#if RJ > 2
                int k[2] = {G[I].g[j[a][A]], G[I].g[j[a][L]]};
#endif
                ...
                {            // Search 5th Cell position 54 mini-Lines away Box/Line wise
                  ...
                  {          // Search 6th Cell position 54 mini-Lines away Box/Line wise
                    if (!G[I].g[j[a][Z]] || (G[I].g[j[a][N]] | G[I].g[j[a][X]] | G[I].g[j[a][Z]]) != Y ||
                      ...
                      continue;
#if RJ > 2
                    int k[3] = {G[I].g[j[a][A]], G[I].g[j[a][L]], G[I].g[j[a][M]]};
#endif
...
#if RJ > 2
          int k[4] = {G[I].g[K[0]], G[I].g[K[2]], G[I].g[K[4]], G[I].g[K[5]]};
#endif
...
XYWT1Tf:
          ...
          if ((G[I].g[w[K[0]][6]] | G[I].g[w[K[0]][7]] | G[I].g[w[K[2]][6]] | G[I].g[w[K[2]][7]] |
          ...
          {                  // Wing Cells common value not in 1st Wing and Hybrid Cells Column other Cells values
            k[0] = 1;        // Backup and remove Wing Cells common value from XYZ-Hybrid Row wise removal Cells values
            G[I].g[w[K[0]][6]] &= ~K[5];
            G[I].g[w[K[0]][7]] &= ~K[5];
            G[I].g[w[K[2]][6]] &= ~K[5];
            G[I].g[w[K[2]][7]] &= ~K[5];
          ...
          if ((G[I].g[w[K[0]][12]] | G[I].g[w[K[0]][13]] | G[I].g[w[K[4]][12]] | G[I].g[w[K[4]][13]] |
          ...
          {                  // Wing Cells common value not in 2nd Wing and Hybrid Cells Row other Cells values
            k[1] = 1;        // Backup and remove Wing Cells common value from XYZ-Hybrid Column wise removal Cells values
            G[I].g[w[K[0]][12]] &= ~K[5];
            G[I].g[w[K[0]][13]] &= ~K[5];
            G[I].g[w[K[4]][12]] &= ~K[5];
            G[I].g[w[K[4]][13]] &= ~K[5];
          ...
          if ((k[0] & k[1]) + 1)
          {
            ...
            printf ("%d)%sXYZ-Hybrid: %d @ r%dc%d %s %s Hybrid %d @ %s => -%d @",
              G[I].p, (k[0] | k[1]) + 1 ? " Dual " : " ", b[G[I].g[K[2]] | G[I].g[K[4]]],
          ...
          {                  // Search 2nd Wing Cell position Box wise but not in 1st Wing Line
            ...
            ((G[I].g[K[0]] & K[5]) && B[G[I].g[K[0]]] != 3))
              continue;      // Wing Cells common value in Apex Cell values; and Apex Cell values not three digits
                             // Drop XY-Wing Type 2 and XYZ-Wing from removal Cells values
